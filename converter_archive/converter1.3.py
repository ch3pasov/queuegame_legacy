...
procedure=int((cl-op-(lunch_finish-lunch_start))/(0.75 * playersnum)) #время получения услуги
#print(procedure)
...
f=open('out', 'w')
wnline(f, 'Сегодня кабинет обслуживает человека за ' + str(procedure) + ' минут!')
